<template>
  <div class="">
    <Head>
      <Title>
        {{
          service && service.title ? `TH | ${service.title}` : '404 | Not Found'
        }}
      </Title>
      <Meta
        name="description"
        :content="service && service.title ? service.title : '404 | Not Found'"
      />
    </Head>
    <div
      class="flex-grow pt-[4.5rem] md:pt-[4.3rem] pb-2 kontener mx-auto justify-center"
    >
      <div
        ...
        >
          <template v-if="pending">
            <div role="status" class="w-full kontener animate-pulse">
              ...
              />
              <div
                class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-1/3 mb-2.5"
              />
              <div
              ...
              />
              <div
                class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-1/2 mb-2.5"
              />
              <div
                class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-full mb-2.5"
              />
              ...
              />
              <div
                class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 1/4"
              />
              <div
                class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-1/4 mb-2.5"
              />
          ...
          <template v-else>
            <template v-if="service.id">
              ...
              <div
                class="text-lg mt-4 text-justify px-0 md:px-2"
