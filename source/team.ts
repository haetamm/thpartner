  ...
  return [
    {
      ...
      description: '<div>Dennis is the founder and managing director of the firm. He has an unquenchable passion for the law that has not subsided even after more than 23 years in practice. Denni\'s many years of practice has seen him argue countless cases in both the State Courts and the Supreme Court. You can rest assured that you are in good hands when you choose to tap on Denni\'s expertise. </div><div>Dennis graduated with honours from the University of London and is also admitted as a barrister in the United Kingdom.</div>',
