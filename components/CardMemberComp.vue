<template>
  <div class="content my-0">
    <div class="card min-h-48 rounded-none xs:rounded-tl-md xs:rounded-tr-md">
      <div class="firstinfo h-[200]px] xs:h-[180px] md:h-[260px] lg:h-[190px] py-2">
        <img src="/owner.webp">
        <div class="profileinfo">
          ...
          <p class="bio">
            Dennis is the founder and managing director of the firm. He has an unquenchable passion for the law that has not subsided even after more than...
          </p>
        </div>
      </div>
    </div>
    <div class="p-1 px-6 md:px-2 shadow-custom shadow-xl bg-white justify-between flex rounded-none xs:rounded-bl-md xs:rounded-br-md">
      <svg
        id="Layer_1"
